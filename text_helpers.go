...
func (t *TxtToOne) Uniq() (err error) {
	if t.Function.Name == t.LocalTable.ColumnNameGo {
		fmt.Printf("TxtToOne: Duplicated method and field %s, rename the func to %sX\n", t.Function.Name, t.Function.Name)
		t.Function.Name = t.Function.Name + "X"
	}

	if t.Function.ForeignName == t.ForeignTable.ColumnNameGo {
		fmt.Printf("TxtToOne: Duplicated method and field %s, rename the func to %sX\n", t.Function.Name, t.Function.Name)
		t.Function.ForeignName = t.Function.ForeignName + "X"
	}
...
func (t *TxtToMany) Uniq() (err error) {
	if t.Function.Name == t.LocalTable.ColumnNameGo {
		fmt.Printf("TxtToMany: Duplicated method and field %s, rename the func to %sX\n", t.Function.Name, t.Function.Name)
		t.Function.Name = t.Function.Name + "X"
	}
